...
#ifdef USE_SPIN32
	RCC_AHB2ENR |= RCC_AHB2ENR_GPIOEEN;
	GPIOE_AFRH |= 0x222222; // E8 (TIM1_CH1N), E9 (TIM1_CH1), E10 (TIM1_CH2N), E11 (TIM1_CH2), E12 (TIM1_CH3N), E13 (TIM1_CH3)
	GPIOE_ODR |= 0x80; // E7 (WAKE=1)
	GPIOE_MODER &= ~0x5558000; // E7 (output), E8 (TIM1_CH1N), E9 (TIM1_CH1), E10 (TIM1_CH2N), E11 (TIM1_CH2), E12 (TIM1_CH3N), E13 (TIM1_CH3)
#else
	GPIOA_AFRH |= 0x666; // A8 (TIM1_CH1), A9 (TIM1_CH2), A10 (TIM1_CH3)
	GPIOA_MODER &= ~0x150000; // A8 (TIM1_CH1), A9 (TIM1_CH2), A10 (TIM1_CH3)
#ifdef USE_XOR

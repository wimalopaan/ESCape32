...
void init(void) {
	...
	SYSCFG_CFGR1 = SYSCFG_CFGR1_UCPD1_STROBE; // Disable internal pull-downs on A8/B15
#ifndef USE_32PIN
	SYSCFG_CFGR1 |= SYSCFG_CFGR1_PA11_RMP | SYSCFG_CFGR1_PA12_RMP; // Remap A11->A9,A12->A10
#endif
